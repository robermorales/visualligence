...
echo cars.data.des 1>&2
sed 's/.//' >cars.data.des <<'//GO.SYSIN DD cars.data.des'
--f
-mpg REAL 1
-cylinders REAL 2
-displacement REAL 3
...
-model.year REAL 7
-origin REAL 8
//GO.SYSIN DD cars.data.des
echo cars.names 1>&2
sed 's/.//' >cars.names <<'//GO.SYSIN DD cars.names'
...
-"ford ranger"
-"chevy s-10"
//GO.SYSIN DD cars.names
echo cars.data 1>&2
sed 's/.//' >cars.data <<'//GO.SYSIN DD cars.data'
